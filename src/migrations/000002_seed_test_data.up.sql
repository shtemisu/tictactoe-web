...
-- GAME OVER
INSERT INTO games (id, board, firstPlayer_id, secondPlayer_id, current_turn, status, winner, created_at, updated_at) VALUES
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', ARRAY[1,1,1,2,2,0,0,0,0], '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'game_over', '11111111-1111-1111-1111-111111111111', NOW(), NOW());

-- DRAW
INSERT INTO games (id, board, firstPlayer_id, secondPlayer_id, current_turn, status, winner, created_at, updated_at) VALUES
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', ARRAY[1,2,1,1,2,2,2,1,1], '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', NULL, 'draw', NULL, NOW(), NOW());